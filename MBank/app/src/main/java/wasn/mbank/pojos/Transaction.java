...
/**
 * class to hold transaction details
 * @author eranga
 */
public class Transaction {
	...
	public Transaction(String branchId, String clinetName, String clinetNic,
			String clientAccountNo, String previousBalance,
			String transactionAmount, String currentBalance,
			String transactionTime, String receiptId, String clientId,
			String transactionType, String checkNo, String description) {
		super();
